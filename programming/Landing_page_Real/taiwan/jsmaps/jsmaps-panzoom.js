...
! function() {
  ...
  function o(o) { for (var e = o.offsetLeft, t = o.offsetTop; o.offsetParent && o !== document.getElementsByTagName("body")[0];) e += o.offsetParent.offsetLeft, t += o.offsetParent.offsetTop, o = o.offsetParent; return [e, t] }

  function e(e, t) { var r, n, i; return e.pageX || e.pageY ? (r = e.pageX, n = e.pageY) : (r = e.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, n = e.clientY + document.body.scrollTop + document.documentElement.scrollTop), i = o(t), r -= i[0], n -= i[1], { x: r, y: n } }
  var t = { enable: function() { this.enabled = !0 }, disable: function() { this.enabled = !1 }, zoomIn: function(o) { this.applyZoom(o) }, zoomOut: function(o) { this.applyZoom(o > 0 ? -1 * o : o) }, zoomReset: function() { this.resetZoom() }, pan: function(o, e) { this.applyPan(-1 * o, -1 * e) }, isDragging: function() { return this.dragTime > this.dragThreshold }, getCurrentPosition: function() { return this.currPos }, getCurrentZoom: function() { return this.currZoom } },
    r = function(o, t) {
      function r() {
      ...
      function i(o, e) {
        if (!l.enabled) return !1;
        l.currZoom += o, l.currZoom < h.minZoom ? l.currZoom = h.minZoom : l.currZoom > h.maxZoom ? l.currZoom = h.maxZoom : (e = e || { x: s.width / 2, y: s.height / 2 }, f = s.width * h.zoomStep * (e.x / s.width) * o, p = s.height * h.zoomStep * (e.y / s.height) * o, r())
      }
